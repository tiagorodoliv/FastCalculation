...
class GameFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val onClickListener = View.OnClickListener{
            ...
            roundDeadlineHandler.removeMessages(MSG_ROUND_DEAD_LINE)
            play()
        }
    ...
    companion object {
        private const val MSG_ROUND_DEAD_LINE = 0
        @JvmStatic
    ...
    private  fun play(){
        ...
        if (currentRound!= null){
            ...
            roundDeadlineHandler.sendEmptyMessageDelayed(MSG_ROUND_DEAD_LINE, settings.roundInterval)
        }else{
